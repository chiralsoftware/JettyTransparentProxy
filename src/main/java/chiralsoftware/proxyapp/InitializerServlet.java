 ...
 */
@WebServlet(name = "InitializerServlet", // urlPatterns = {"/InitializerServlet"}, 
        loadOnStartup = 1)
public final class InitializerServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        super.init(config);
        LOG.info("In the InitializerServlet, setting an executor in the ServletContext");
        getServletContext().setAttribute(executorAttribute, newCachedThreadPool());
    }
